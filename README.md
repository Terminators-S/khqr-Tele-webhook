...
7. For Telegram observation, create a dedicated session and run `scripts/telegram_shadow_preflight.py` before starting the `telegram` profile. Shadow mode and both cutover fuses are safe by default.

See docs/IMPORT_FROM_CREATIVE_STUDIO.md for the extraction boundary.
